				...
				<div class="col-lg-11">
					...
					<div class="page-header col-sm-12">
						...
						<div class="panel-body">
							<form class="form-horizontal" role="form" action="student!addStu" method="post">
								<h3 class="mb">基本信息</h3>
								<div class="form-group">
									<label class="control-label col-sm-3" for="notNull">姓名</label>
									<div class="col-sm-8 col-md-6 col-lg-5">
										<input type="text" name="newStudent.stuName" class="form-control"
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-md-6 col-lg-5">
                                       <input type="text" name="newStudent.stuBirthday" id="birth" class="datepicker form-control" autocomplete="off">
                                    </div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3" for="">联系电话</label>
									<div class="col-sm-8 col-md-6 col-lg-5">
										<input type="text" name="newStudent.stuMobile" class="form-control"
											 placeholder="联系电话">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-md-6 col-lg-5">
										<input type="text" name="newStudent.stuCity" class="form-control"
										 placeholder="家庭地址">
									</div>
								</div>
